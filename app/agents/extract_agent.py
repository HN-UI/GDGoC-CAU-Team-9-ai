...
""".strip()
        ...
        # 변경 배경:
        # - 이전 한계점: 1차 응답이 JSON이 아니면 빈 결과로 끝나 메뉴 추출 성능이 급락했다.
        # - 변경 내용: 동일 요청을 1회 재시도해 일시적 포맷 오류를 흡수한다.
        ...
        data = data or {}
        # 변경 배경:
        # - 이전 한계점: normalize 과정에서 공백/중복 정리가 빠지면 downstream 메뉴 매칭이 흔들렸다.
        # - 변경 내용: normalize_list로 입력 품질을 고정해 후속 Agent 입력 안정성을 높인다.
